...
typedef struct { uint64_t phys; page_t* virt; } __attribute__((packed)) page_table_t;
...
typedef struct PageMap { pdpt_entry_t* pdpt; pd_entry_t** pageDirs; uint64_t* pageDirsPhys; page_t*** pageTables; pml4_entry_t* pml4; uint64_t pdptPhys; uint64_t pml4Phys; } __attribute__((packed)) page_map_t;
struct PageFaultTrap { uintptr_t instructionPointer; void (*handler)(); };
class AddressSpace;
namespace Memory {
