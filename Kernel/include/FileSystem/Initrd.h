...
#define LORIINITFS_FILE        0x01
#define LORIINITFS_DIRECTORY   0x02
#define LORIINITFS_SYMLINK     0x03
#define LORIINITFS_MOUNTPOINT  0x04
...
namespace Initrd
{
    ...
    uint8_t* Read(loriinitfs_node_t node, uint8_t* buffer);
}
