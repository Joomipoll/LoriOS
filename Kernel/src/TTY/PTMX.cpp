...
PTMultiplexor::PTS::PTS(PTMultiplexor& ptmx) : Device("pts", DeviceTypeUNIXPseudo), m_ptmx(ptmx)
{
...
int PTMultiplexor::PTS::Create(DirectoryEntry*, uint32_t){ return -EPERM; }
int PTMultiplexor::PTS::CreateDirectory(DirectoryEntry*, uint32_t){ return -EPERM; }
int PTMultiplexor::PTS::Link(FsNode*, DirectoryEntry*){ return -EPERM; }
int PTMultiplexor::PTS::Unlink(DirectoryEntry*, bool){ return -EPERM; }
PTMultiplexor::PTMultiplexor() : Device("ptmx", DeviceTypeUNIXPseudo), m_pts(*this)
{
