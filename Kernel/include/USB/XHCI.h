...
#define USB_STS_SSS (1 << 8)
#define USB_STS_RSS (1 << 9)
#define USB_STS_SRE (1 << 10)
#define USB_STS_CNR (1 << 11)
#define USB_STS_HCE (1 << 12)

#define USB_CFG_MAXSLOTSEN (0xFF)
#define USB_CFG_U3E (1 << 8)
#define USB_CFG_CIE (1 << 9)

#define USB_CCR_RCS (1 << 0)
#define USB_CCR_CS (1 << 1)
#define USB_CCR_CA (1 << 2)
#define USB_CCR_CRR (1 << 3)

#define USB_CCR_PTR_LO 0xFFFFFFC0‬
#define USB_CCR_PTR 0xFFFFFFFFFFFFFFC0‬
...
protected:
    ...
    typedef struct
    {
        ...
        inline uint8_t MaxSlots()
        {
            return hcsParams1 & 0xFF;
        }

        inline uint16_t MaxIntrs()
        {
            return (hcsParams1 >> 8) & 0x3FF;
        }

        inline uint8_t MaxPorts()
        {
    ...
    typedef struct
    {
        ...
        uint32_t intModerationInterval : 16;
        uint32_t intModerationCounter : 16;
