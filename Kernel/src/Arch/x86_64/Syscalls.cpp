...
long SysUName(RegisterContext* r) {
    if (Memory::CheckUsermodePointer(SC_ARG0(r), strlen(Lori::versionString),
                                     Scheduler::GetCurrentProcess()->addressSpace)) {
        strcpy((char*)SC_ARG0(r), Lori::versionString);
        return 0;
    }
...
long SysInfo(RegisterContext* r) {
    Lori_sysinfo_t* s = (Lori_sysinfo_t*)SC_ARG0(r);
...
long SysGetProcessInfo(RegisterContext* r) {
    ...
    Lori_process_info_t* pInfo = reinterpret_cast<Lori_process_info_t*>(SC_ARG1(r));

    Process* cProcess = Scheduler::GetCurrentProcess();
    if (!Memory::CheckUsermodePointer(SC_ARG1(r), sizeof(Lori_process_info_t), cProcess->addressSpace)) {
        return -EFAULT;
    }
