...
void KernelProcess() {
    ...
    if (HAL::useKCon || !(initFsNode = fs::ResolvePath("/system/lori/init.lef"))) { // Attempt to start fterm
...
extern "C" [[noreturn]] void kmain() {
    ...
    Video::DrawString(Lori::versionString, 2, videoMode.height - 20, 255, 255, 255);
