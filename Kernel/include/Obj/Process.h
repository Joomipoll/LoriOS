...
public:
    ...
    static FancyRefPtr<Process> CreateELFProcess(void* elf, const Vector<String>& argv, const Vector<String>& envp, const char* execPath, Process* parent);
     ...
     */
    uintptr_t LoadELF(uintptr_t* stackPointer, struct ELFInfo elfInfo, const Vector<String>& argv, const Vector<String>& envp, const char* execPath);
     ...
     * Lori OS does not currently support killing the main thread.
     */
...
private:
    ...
    /*
        ...
        This facilitates both Lori-specific and standard UNIX handling
        of processes
